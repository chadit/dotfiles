...
local has_mappings, wk_mappings = pcall(extend_table, "error",
                                        gitsigns_mappings, lsp_mappings,
                                        nvimtree_mappings, package_info,
                                        telescope_mappings, trouble_mappings,
                                        ts_lsp_mappings)
