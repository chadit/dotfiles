...
local function set_mappings(client, bufnr)
  ...
  if client.resolved_capabilities.document_formatting or client.resolved_capabilities.document_range_formatting then mappings.n["<space>fd"] = "<cmd>lua require('util.lsp').efm_priority_document_format()<CR>" end
...
function M.on_attach(client, bufnr)
  ...
  vim.lsp.handlers["textDocument/publishDiagnostics"] = vim.lsp.with(vim.lsp.diagnostic.on_publish_diagnostics, {underline = true, signs = true, update_in_insert = false, virtual_text = false})
  -- end TODO
